        ...
        >
          ...
          >
            <motion.h1
              ...
              initial="hidden"
              whileInView="visible"
              animate={isTransitioning ? langAnimate : "visible"}
              transition={{ ...defaultTransition, delay: 0.15 }}
              className="text-[clamp(2.3rem,10vw,8rem)] font-bold font-experimental text-white tracking-tighter leading-[0.85] text-balance"
            >
              {t.hero.title}
          ...
          >
            ...
            />
            <motion.p
              className="text-base sm:text-lg md:text-xl text-white/70 max-w-sm sm:max-w-md font-light leading-relaxed text-balance"
              animate={isTransitioning ? langAnimate : { opacity: 1, x: 0 }}
              transition={langTransition}
            >
              {t.hero.description}
